...
`;function yo(){const[t,n]=(0,e.useState)(0),[r,i]=(0,e.useState)(!0),[o,a]=(0,e.useState)(!1),[l,s]=(0,e.useState)(!1);return(0,e.useEffect)((()=>{window.scrollTo(0,0);const e=()=>{a(window.innerWidth<=768)};e(),window.addEventListener("resize",e);const t=setTimeout((()=>{s(!0)}),100);return()=>{clearTimeout(t),window.removeEventListener("resize",e)}}),[]),(0,e.useEffect)((()=>{let e=0;const t=()=>{e++;n(e/2*100),2===e&&setTimeout((()=>{i(!1)}),500)},r=document.createElement("video");r.src=qi,r.type="video/webm",r.load(),r.oncanplaythrough=t,r.onerror=t;const o=document.createElement("video");o.src=Ji,o.type="video/webm",o.load(),o.oncanplaythrough=t,o.onerror=t}),[]),(0,e.useEffect)((()=>{if(!r){const e=document.querySelector(".desktop-video"),t=document.querySelector(".mobile-video"),n=e=>{if(e&&e.paused){const t=e.play();void 0!==t&&t.catch((()=>{const t=()=>{e.play(),document.removeEventListener("touchstart",t),document.removeEventListener("click",t),document.removeEventListener("scroll",t)};document.addEventListener("touchstart",t),document.addEventListener("click",t),document.addEventListener("scroll",t)}))}};setTimeout((()=>{o&&t?n(t):e&&n(e)}),1e3)}}),[r,o]),(0,Jr.jsxs)(eo,{children:[(0,Jr.jsxs)(co,{children:[(0,Jr.jsx)(fo,{className:"desktop-video",src:qi,type:"video/webm",autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto",poster:"","webkit-playsinline":"true","x5-playsinline":"true","x5-video-player-type":"h5","x5-video-player-fullscreen":"false",onError:e=>e.target.classList.add("video-error"),onLoadStart:e=>{const t=e.target;t.play().catch((()=>{document.addEventListener("touchstart",(()=>t.play()),{once:!0})}))}}),(0,Jr.jsx)(fo,{className:"mobile-video",src:Ji,type:"video/webm",autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto",poster:"","webkit-playsinline":"true","x5-playsinline":"true","x5-video-player-type":"h5","x5-video-player-fullscreen":"false",onError:e=>e.target.classList.add("video-error"),onLoadStart:e=>{const t=e.target;t.play().catch((()=>{document.addEventListener("touchstart",(()=>t.play()),{once:!0})}))}}),(0,Jr.jsx)(po,{})]}),(0,Jr.jsxs)(ho,{$isLoading:r,children:[(0,Jr.jsx)(mo,{src:qr,alt:"GeoSpatios Logo"}),(0,Jr.jsxs)(go,{children:["Loading... ",Math.round(t),"%"]}),(0,Jr.jsx)(vo,{progress:t})]}),(0,Jr.jsxs)(ro,{children:[(0,Jr.jsx)(vi,{}),(0,Jr.jsx)(io,{children:(0,Jr.jsxs)(ao,{children:[(0,Jr.jsxs)(no,{children:["AI Command & Control ",(0,Jr.jsx)("br",{})," for the Physical World"]}),(0,Jr.jsxs)(lo,{children:["Unite high-stakes operations in one command center, ",(0,Jr.jsx)("br",{}),"from data to decisions at machine speed"]}),(0,Jr.jsxs)(to,{children:[(0,Jr.jsx)(so,{href:"https://form.typeform.com/to/rx0GxJYm",rel:"noopener noreferrer",children:"Request Demo"}),(0,Jr.jsx)(uo,{href:"/manifesto",children:"Learn More"})]})]})}),(0,Jr.jsxs)(oo,{children:[(0,Jr.jsx)(xo,{}),(0,Jr.jsx)(Qi,{})]})]})]})}const bo=e.memo(yo),wo=Gr.div`
  width: 100%;
  min-height: 100vh;
  position: relative;
  background: #000;
...
`;const Ya=function(){(0,e.useEffect)((()=>{window.scrollTo(0,0)}),[]);const t=[{icon:(0,Jr.jsx)(zi,{}),title:"Developer Resources",description:"Access comprehensive documentation, sandbox environments, and reference applications to build and deploy solutions on Geo OS for Earth-scale operations."},{icon:(0,Jr.jsx)(Ni,{}),title:"Testing & Validation",description:"Utilize our testing frameworks and simulation environments to ensure your solutions meet the highest standards of reliability for mission-critical Earth operations."},{icon:(0,Jr.jsx)(Li,{}),title:"Integration Support",description:"Seamlessly integrate your solutions with Geo OS through our standardized APIs and SDKs, with direct access to our engineering team."}],n=[{icon:(0,Jr.jsx)(Ri,{}),title:"Early Access",description:"Get priority access to new APIs, features, and Platform capabilities before general release, enabling you to build cutting-edge Earth operations solutions."},{icon:(0,Jr.jsx)(Ni,{}),title:"Technical Support",description:"Direct access to our engineering team for architecture reviews, technical guidance, and optimization of your integrated solutions."},{icon:(0,Jr.jsx)(Li,{}),title:"Innovation Partnership",description:"Collaborate on developing novel solutions and shape the future of autonomous Earth operations through direct input into our product roadmap."}];return(0,Jr.jsxs)(Oa,{children:[(0,Jr.jsx)(_o,{}),(0,Jr.jsx)(vi,{}),(0,Jr.jsxs)(Da,{children:[(0,Jr.jsxs)(La,{children:[(0,Jr.jsxs)(Na,{children:["Open Ecosystem ",(0,Jr.jsx)("br",{})," for Autonomous Earth Operations"]}),(0,Jr.jsx)(Aa,{children:"The Geo OS Partner Program enables organizations to create, integrate, and deploy transformative solutions for next-generation Earth operations."})]}),(0,Jr.jsxs)(Fa,{children:[(0,Jr.jsx)(Ma,{children:"Partner Resources"}),(0,Jr.jsx)(Ia,{children:t.map(((e,t)=>(0,Jr.jsxs)($a,{children:[(0,Jr.jsx)(Ua,{children:e.icon}),(0,Jr.jsx)(Ba,{children:e.title}),(0,Jr.jsx)(Wa,{children:e.description})]},`resource-${t}`)))})]}),(0,Jr.jsxs)(Fa,{children:[(0,Jr.jsx)(Ma,{children:"Partner Benefits"}),(0,Jr.jsx)(Ia,{children:n.map(((e,t)=>(0,Jr.jsxs)($a,{children:[(0,Jr.jsx)(Ua,{children:e.icon}),(0,Jr.jsx)(Ba,{children:e.title}),(0,Jr.jsx)(Wa,{children:e.description})]},`benefit-${t}`)))})]}),(0,Jr.jsxs)(Ha,{children:[(0,Jr.jsx)(Na,{style:{fontSize:"2.5rem",marginBottom:"30px"},children:"Ready to become a partner?"}),(0,Jr.jsx)(Va,{href:"https://form.typeform.com/to/rx0GxJYm",rel:"noopener noreferrer",children:"Apply Now"})]}),(0,Jr.jsx)(Qi,{})]})]})},Ga=Gr.div`
  min-height: 100vh;
  background: black;
  color: white;
  display: flex;
...
//# sourceMappingURL=main.efc478c5.js.map